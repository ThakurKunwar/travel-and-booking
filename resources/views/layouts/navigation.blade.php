<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center gap-3 sm:ms-6">
                ...
                <a href="{{ route('packages.index') }}"
                   class="px-4 py-1.5 bg-orange-400/90 hover:bg-orange-400
                          {{ request()->routeIs('packages.*') ? 'ring-2 ring-orange-300 ring-offset-1' : '' }}
                          text-white text-sm font-medium rounded-full transition-all duration-150 shadow-sm">
                    Book Now
                </a>
    ...
    <a href="{{ route('register') }}"
       class="px-4 py-1.5 bg-gray-800 hover:bg-gray-700 text-white text-sm font-medium rounded-full transition shadow-sm">
        Sign up
    </a>
@endauth
